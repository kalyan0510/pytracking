...
class LTRTrainer(BaseTrainer):
    ...
    def cycle_dataset(self, loader):
        ...
        for i, data in enumerate(loader, 1):
            ...
            loss, stats = self.actor(data, i, self.save_data_to_file, is_training=loader.training, num_gpu=self.settings.num_gpu if hasattr(self.settings, 'num_gpu') else None)
            acting_time = time.time() - acting_starts
            # print("running gradiant calc")
