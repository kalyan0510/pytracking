...
def parameters():
    ...
    # Temporal feat Parameters
    params.num_temporal_frames = 10
    params.feature_select_threshold = 0.4
    params.misplaced_train_frame_pos = True
    ...
    params.net = NetWithBackbone(net_path='ToMPnet_ep0162.pth_2nditrafter300_85.1.tar', use_gpu=params.use_gpu)
