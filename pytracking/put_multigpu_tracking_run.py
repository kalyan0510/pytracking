class RunCommandMaker:
    ...
    def __init__(self, total_tests, gpu_ids, tracker_name, param_names):
    ...
    def make_cmd(self, st, ed, gpu_id, param_name):
        return f'conda activate pytracking1 ; cd ~/desk/pytracking/pytracking/ ; CUDA_VISIBLE_DEVICES={gpu_id} python run_tracker.py {self.tracker_name} {param_name} --dataset_name lasot --sequence {st}:{ed}'
...
if __name__ == '__main__':
    ...
    RunCommandMaker(total_tests, gpu_ids, tracker_name, param_names).make_cmds()
